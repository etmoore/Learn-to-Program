def english_number number
  ...
  # "left" is how much of the number we still have
  # left to write out.
  ...
  if write > 0
    if ((write == 1) and (left > 0))
      ...
      # Since we toolk care of the digit in the ones place
...
while num_bottles > 2
  puts english_number(num_bottles) + ' bottles of beer on the wall, ' + english_number(num_bottles) + ' bottles of beer.'
  num_bottles -= 1
  puts 'Take one down, pass it around, ' + english_number(num_bottles) + ' bottles of beer on the wall.'
end
